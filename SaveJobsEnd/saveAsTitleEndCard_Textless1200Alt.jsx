...
// Hide layer
hideLayerByName(tempDoc.layers, "Header");
hideLayerByName(tempDoc.layers, "Please support my series!");
hideLayerByName(tempDoc.layers, "subscription methods:");
